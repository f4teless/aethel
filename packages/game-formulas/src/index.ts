 ...
 */
export function calculateGraceTime(level: number): number {
 ...
 */
export function calculateHpDrainPerMinute(level: number): number {
 ...
 */
export function calculateWrongSubmissionDamage(level: number): number {
  const maxHp = calculateMaxHp(level);
 ...
 */
export function calculateStoryQuestMpCost(level: number): number {
 ...
 */
export function calculateMpRegen(lastRegenTime: Date, currentTime: Date = new Date()): number {
 ...
 */
export function canAffordMpCost(currentMp: number, cost: number): boolean {
 ...
 */
export function applyHpDamage(currentHp: number, damage: number): number {
 ...
 */
export function applyMpCost(currentMp: number, cost: number): number {
